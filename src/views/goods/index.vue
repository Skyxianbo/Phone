    ...
    <div class="app-container">
        ...
        <div ref="indexTable">
            <el-table :height="height" :data="list" element-loading-text="Loading" border fit highlight-current-row>
                ...
                <el-table-column label="商品型号" align="center">
                    <template slot-scope="scope">
                        {{scope.row.model}}
                    </template>
                </el-table-column>
                ...
                <el-table-column align="center" label="操作">
                    <template slot-scope="scope">
                        ...
                        <a style="color: #409EFF" href="#" @click.prevent="deleteGoods(scope.row.id)">删除</a>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
import { getGoods, addGoods, deleteGoods } from '@/api/goods';
export default {
    data() {
        return {
            boxTop: '',
